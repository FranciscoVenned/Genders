...
import com.github.franciscovenned.franciscogender.utils.Config;
...
public class PlayerData {
    ...
    public void save() {
        new BukkitRunnable() {
            ...
            @Override
            public void run() {
                Config config = new Config(Gender.getInstance(), "players/" + uuid.toString());
        ...
        }.runTaskAsynchronously(Gender.getInstance()); // Se ejecutara fuera del hilo principal.
    }
    ...
    public void load() {
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                if (config.contains("genero")){
                    genero = config.getString("genero");
                }
